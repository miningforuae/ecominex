    ...
    return (
        <div className="relative overflow-hidden bg-[#000]">
            ...
            <div className="grid grid-cols-2 min-h-screen">
                <div className="bg-[#000] h-full flex flex-col gap-4 justify-center items-center px-16">
                    <div className="">
                        <img className="" src="/resetpassword.jpg" alt="" />
                    </div>

                </div>

                <div className="bg-[#111111] rounded-l-[20px] pt-0 h-full flex flex-col gap-2 justify-center px-16">
                    <img className="w-24" src="/GlowingKey.png" alt="" />

                    <div className="flex flex-col gap-3 justify-start items-start">
                        <h1 className="text-[#f0f0f0] font-[500] text-[33px] tracking-[0px]">
                            Reset Password
                        </h1>

                        <form
                            onSubmit={handleSubmit}
                            className="w-[90%] flex flex-col gap-7 mt-3.5"
                        >
                            {/* EMAIL INPUT */}
                            <div className="relative w-full mt-0">
                                <input
                                    ...
                                    className="
                                        ...
                                        focus:border-green-500 text-white px-3 h-[50px] pt-0 pl-3.5 text-[13.5px]
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <Link href="/auth/signin">
                                    <h6 className="font-[500] text-[15px] text-green-500">
                                        Go To Login Page
                                    </h6>
                                </Link>
                            </div>
